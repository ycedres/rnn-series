...
ts = pipelines.wind_power_parks_ts(filename=base_dir+input_filename)
ts.to_csv('/tmp/ts.csv')

df = pipelines.wind_power_parks_features(filename=base_dir+input_filename,
...
train_set = train_set.drop(['target_h12'],axis=1)
